...
describe("words()", function() {
  ...
  it("handles properties that has boolean values", function() {
    var expectedCounts = { true: 1, and: 1, false: 1,  are: 1, boolean: 1, values: 1};
    expect(myApp.words("true and false are boolean values")).toEqual(expectedCounts);
  });

  it("handles properties that has keywords", function() {
    var expectedCounts = {return: 1, Object: 1, function: 1};
    expect(myApp.words("return Object function")).toEqual(expectedCounts);
  });
});